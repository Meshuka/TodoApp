...
const App = () => {
  ...
  const addTask = (e) => {
    ...
    const currentDate =
      date.toLocaleDateString() + " Time:" + date.toLocaleTimeString();
  ...
  const submitEdit = (e, id) => {
    ...
    const updatedDate1 =
      editted.toLocaleDateString() + " Time:" + editted.toLocaleTimeString();
                      ...
                      {t.isCompleted ? null : (
                        <div className="list-item">
                          <li>
                            ...
                            {t.editCount > 0 ? (
                              <i className="date">
                                Updated on: {t.dateOfUpdation}
                              </i>
                            ) : (
                              <i className="date">
                                Created on: {t.dateOfCreation}
                              </i>
                            )}
                            {editId === t.id ? (
                        ...
                        {t.isCompleted ? (
                          <div className="cross-text">
                            <li>
                              <input
                                type="checkbox"
                                className="task-comlete"
                                defaultChecked
                                onClick={(e) => incompleteTask(e, t.id1)}
                              ></input>
                              {t.value}
